...
{\it baseline2018a}), based on detailed operations simulations, is shown for the
...
(this magnitude distribution corresponds to a size distribution $dN/dD \propto 1/D^\beta$,
with $\beta = 5\alpha+1$). 
